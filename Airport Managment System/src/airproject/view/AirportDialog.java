...
public class AirportDialog extends JDialog {
	...
	public static void main(String[] args) {
		AirportDialog f = new AirportDialog(null, "New airport", true);
	}

	public AirportDialog(JFrame owner, String title, boolean modal) {
	...
	public void addSpecBtns() {
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AirportDialog.this.setVisible(false);
				AirportDialog.this.dispose();
			}
		});
	}
	...
	public void updateAirportName(String name){
		txtAirportName.setText(name);
	}
	
	public void updateAirportCode(String code){
		txtAirportCode.setText(code);
	}
	...
	public RunwayDialog openCreationOfNewRunway() {
		newRunwayFrame = new RunwayDialog(AirportDialog.this,
				"New runway", false);
